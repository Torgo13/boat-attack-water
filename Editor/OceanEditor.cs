...
namespace WaterSystem
{
    ...
    public class OceanEditor : Editor
    {
        ...
        // reflection
        private SerializedProperty reflectionType;
        ...
        private void OnEnable()
        {
            ...
            // Reflection Settings
            reflectionType = settings.FindPropertyRelative(nameof(Data.OceanSettings.refType));
        ...
        void DoReflection()
        {
            EditorGUILayout.PropertyField(reflectionType, Styles.refType);
            EditorGUI.indentLevel++;
            switch ((Data.ReflectionType)reflectionType.enumValueIndex)
            {
