        ...
        private struct HeightJob : IJobParallelFor
        {
            ...
            public void Execute(int i)
            {
                ...
                for (var wave = 0; wave < BasicWaves.numWaves; wave++) // for each wave
                {
                    ...
                    var wca = amplitude * waveCountMulti;
                    var wa = w * amplitude;
                    var qi = wavelength * (peak * waveCountMulti / 6.28318f);
                    ...
                    var windOmniInput = math.mad(pos, WaveData[wave].onmiDir, omniVec);
